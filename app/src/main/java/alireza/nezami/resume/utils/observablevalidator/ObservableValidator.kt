package alireza.nezami.resume.utils.observablevalidator
...
class ObservableValidator<T : Observable>(
    private val observedObject: T,
    private val bindingResource: Class<*>
) {
    ...
    init {
        observedObject.addOnPropertyChangedCallback(object :
    ...
    fun addRule(
        ...
        Log.d(
            TAG,
            "addRule(field: $field, rule:$rule, message: $message), other field: $otherField, limit: $limit"
        )
    ...
    private fun getProperty(property: String): Any? {
        return observedObject::class.java.getMethod("get" + property.replaceFirstChar {
